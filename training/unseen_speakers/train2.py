...
from lipnet.lipreading.generators import BasicGenerator2
...
from lipnet.model_paper import LipNet
...
def train(run_name, start_epoch, stop_epoch, img_c, img_w, img_h, frames_n, absolute_max_string_len, minibatch_size):
    ...
    lip_gen = BasicGenerator2(dataset_path=DATASET_DIR,
...
if __name__ == '__main__':
    ...
    run_name = '2021-05-23-21-37-10'
    train(run_name, 18, 35, 3, 100, 50, 75, 32, 3)# もともと50