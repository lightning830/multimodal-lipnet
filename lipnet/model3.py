...
class LipNet(object):
    ...
    def build(self):
        ...
        self.zero5 = ZeroPadding3D(padding=(1, 2, 2), name='zero5')(self.maxp4)
        ...
        self.zero6 = ZeroPadding3D(padding=(1, 1, 1), name='zero6')(self.maxp5)
        ...
        self.zero7 = ZeroPadding3D(padding=(1, 1, 1), name='zero7')(self.maxp6)
        ...
        self.zero8 = ZeroPadding3D(padding=(1, 1, 1), name='zero8')(self.maxp7)
        ...
        self.resh2 = TimeDistributed(Flatten())(self.maxp8)
        ...
        self.dense1 = Dense(self.output_size, kernel_initializer='he_normal', name='dense1')(self.concat)
