...
class LipNet(object):
    ...
    def build(self):
        ...
        self.zero5 = ZeroPadding3D(padding=(1, 2, 2), name='zero1')(self.maxp4)
        ...
        self.zero6 = ZeroPadding3D(padding=(1, 1, 1), name='zero2')(self.maxp5)
        ...
        self.zero7 = ZeroPadding3D(padding=(1, 1, 1), name='zero3')(self.maxp6)
        ...
        self.zero8 = ZeroPadding3D(padding=(1, 1, 1), name='zero4')(self.maxp7)
